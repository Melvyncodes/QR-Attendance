...
export default function StudentProfile() {
  ...
  return (
    <View style={styles.container}>
      {(isWeb || sidebarOpen) && (
        <Sidebar role="student" userName={userData ? `${userData.firstName} ${userData.lastName}` : '...'} activeRoute="/screens/student/Profile" />
      )}
      <View style={styles.content}>
        <View style={[styles.topBar, { paddingTop: isWeb ? 19 : 50 }]}>
          {!isWeb && (
            ...
            {editing ? (
              ...
              <>
                ...
                <View style={styles.card}>
                  ...
                  <InfoRow label="Matric Number" value={userData?.matricNumber} />
